...
show_user="$(tnmux_get @tmux_power_show_user false)"
...
if "$show_user"; then
	LS="#[fg=$G04,bg=$TC,bold] $user_icon $user@#h #[fg=$TC,bg=$G06,nobold]$rarrow $LS"
fi
...
RS="#[fg=$TC,bg=$G06]$larrow#[fg=$G04,bg=$TC] $date_icon $date_format "
if "$show_time"; then
	RS="#[fg=$G06]$larrow#[fg=$TC,bg=$G06] $time_icon $time_format $RS"
fi
